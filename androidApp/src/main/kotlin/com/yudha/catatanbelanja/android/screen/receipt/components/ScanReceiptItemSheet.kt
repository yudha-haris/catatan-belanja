...
/**
 * Correcting one line the model read. The same fields as the finished-session sheet, because a
 * scanned item is an ordinary item — it just arrived by camera rather than by keyboard.
 */
@Composable
internal fun ScanReceiptItemSheet(
    item: ShoppingItem,
    emoji: String,
